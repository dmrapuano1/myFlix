...
let topMovies = [
    {
        ...
        //ObjectId("5e5aafb645b176055978609a")
        genre: {
            name: 'Comedy',
    ...
    {
        title: 'Jaws',
        //ObjectId("5e5aafe745b176055978609b")
        genre: {
            name: 'Thriller',
    ...
    },
    {
        ...
        //ObjectId("5e5ab00345b176055978609c")
        genre: {
            name: 'Action',
    ...
    {
        title: 'Rocky',
        //ObjectId("5e5ab01f45b176055978609d")
        genre: {
            name: 'Drama',
    ...
    {
        title: 'Up',
        //ObjectId("5e5ab03545b176055978609e")
        genre: {
            name: 'Animated',
    ...
    {
        title: 'Inception',
        //ObjectId("5e5ab04d45b176055978609f")
        genre: {
            name: 'Thriller',
            description: 'Thriller is a genre of fiction, having numerous, often overlapping subgenres. Thrillers are characterized and defined by the moods they elicit, giving viewers heightened feelings of suspense, excitement, surprise, anticipation and anxiety.'
        },
    ...
    },
    {
        ...
        //ObjectId("5e5ab06345b17605597860a0")
        genre: {
            name: 'Drama',
            description: 'Drama is a genre of narrative fiction (or semi-fiction) intended to be more serious than humorous in tone. Drama of this kind is usually qualified with additional terms that specify its particular subgenre, such as "police crime drama", "political drama", "legal drama", "historical drama", "domestic drama", "teen drama" or "comedy-drama". These terms tend to indicate a particular setting or subject-matter, or else they qualify the otherwise serious tone of a drama with elements that encourage a broader range of moods.',
        },
    ...
    },
    {
        ...
        //ObjectId("5e5ab07a45b17605597860a1")
        genre: {
            name: 'Drama',
            description: 'Drama is a genre of narrative fiction (or semi-fiction) intended to be more serious than humorous in tone. Drama of this kind is usually qualified with additional terms that specify its particular subgenre, such as "police crime drama", "political drama", "legal drama", "historical drama", "domestic drama", "teen drama" or "comedy-drama". These terms tend to indicate a particular setting or subject-matter, or else they qualify the otherwise serious tone of a drama with elements that encourage a broader range of moods.',
        },
    ...
    {
        title: 'The Shining',
        // ObjectId("5e5ab08c45b17605597860a2")
        genre: {
            name: 'Horror',
    ...
    {
        title: 'Groundhog Day',
        // ObjectId("5e5ab09b45b17605597860a3")
        genre: {
            name: 'Drama',
            description: 'Drama is a genre of narrative fiction (or semi-fiction) intended to be more serious than humorous in tone. Drama of this kind is usually qualified with additional terms that specify its particular subgenre, such as "police crime drama", "political drama", "legal drama", "historical drama", "domestic drama", "teen drama" or "comedy-drama". These terms tend to indicate a particular setting or subject-matter, or else they qualify the otherwise serious tone of a drama with elements that encourage a broader range of moods.',
        },
...
let users = [
    {
        ...
        // favoriteMovies: [ObjectId("5e5ab04d45b176055978609f"), ObjectId("5e5ab09b45b17605597860a3")],
    },
    {
        username: 'JOHNdoe',
        ...
        // favoriteMovies: [ObjectId("5e5ab06345b17605597860a0"), ObjectId("5e5ab07a45b17605597860a1")],
    },
    {
        username: 'user1234',
        ...
        // favoriteMovies: [ObjectId("5e5ab03545b176055978609e"), ObjectId("5e5ab07a45b17605597860a1"), ObjectId("5e5ab08c45b17605597860a2")],
    },
    {
        ...
        // favoriteMovies: [ObjectId("5e5ab09b45b17605597860a3"), ObjectId("5e5ab03545b176055978609e"), ObjectId("5e5ab06345b17605597860a0")],
    },
    {
        username: 'Pete_Docter',
        password: 'fakePassw0Rd',
        email: 'Pete_Docter@pixar.com',
        dob: new Date("1992-11-04"),
        // favoriteMovies: [ObjectId("5e5ab03545b176055978609e")],
    },
];
